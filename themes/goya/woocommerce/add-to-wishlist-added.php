...
<div class="yith-wcwl-wishlistaddedbrowse et-tooltip">
	<a href="<?php echo esc_url( $wishlist_url )?>" rel="nofollow" data-title="<?php echo esc_attr( $browse_wishlist_text ) ?>"><span class="text"><?php echo apply_filters( 'yith-wcwl-browse-wishlist-label', $browse_wishlist_text, $product_id, $icon ) ?></span><span class="icon"><?php get_template_part('assets/img/svg/heart.svg'); ?></span></a>
</div>