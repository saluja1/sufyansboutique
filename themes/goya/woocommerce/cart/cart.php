...
<div class="row shopping-cart-content">
	...
	<div class="cart-items col-lg-7 col-xl-8">
		<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
			<?php do_action( 'goya_back_button', $context = 'cart' ); ?>
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="et-product-details" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
									...
									<div class="row">
										...
										<div class="col-md-7 col-sm-12 product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
											<?php
											if ( ! $product_permalink ) {
										...
										<div class="product-subtotal col-md-2 col-6" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
						...
						<td colspan="3" class="actions">
							...
							<?php if ( wc_coupons_enabled() ) { ?>
								<div class="coupon form-row">
									<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php echo esc_attr__( 'Coupon code', 'woocommerce' ); ?>" /> <label for="coupon_code"><?php esc_html_e( 'Coupon code', 'woocommerce' ); ?> </label> <button type="submit" class="button outlined" name="apply_coupon" value="<?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_html_e( 'Apply coupon', 'woocommerce' ); ?></button>
									<?php do_action( 'woocommerce_cart_coupon' ); ?>
								</div>
							<?php } ?>

							<button type="submit" class="button outlined update-cart" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
