...
<div class="images">
	<div id="et-quickview-slider" class="product-images <?php echo esc_attr( $slider_disabled_class ); ?>" data-navigation="true" data-pagination="true" data-autoplay="false" data-columns="1" data-fade="true">
		<?php
		// Featured image
