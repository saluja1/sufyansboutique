		...
		<?php else: ?>
			...
			<div class="woocommerce-tabs tabs-accordion wc-tabs-wrapper">
				<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
					...
					<div class="woocommerce-Tabs-panel woocommerce-Tabs-panel--<?php echo esc_attr( $key ); ?> panel entry-content wc-tab" id="tab-<?php echo esc_attr( $key ); ?>" class="tab-content" role="tabpanel" aria-labelledby="tab-title-<?php echo esc_attr( $key ); ?>">
