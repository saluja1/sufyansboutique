...
<form role="search" method="get" class="woocommerce-product-search searchform" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
	...
	<fieldset>
		<div class="search-button-group">
			...
			<?php goya_search_by_category(); ?>
			
			<button type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>"><?php get_template_part( 'assets/img/svg/search.svg' ); ?></button>
		</div>
