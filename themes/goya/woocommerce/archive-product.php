		...
		<div class="<?php echo esc_attr(implode(' ', $header_bg_class)); ?>">
			<div class="container hero-header-container">
				<header class="row woocommerce-products-header">
					<div class="col-lg-8">
						<?php if (is_shop() && get_theme_mod( 'shop_homepage_title_hide', false ) == true) {
						...
						<?php if ( is_shop() && !is_search() && get_theme_mod('shop_header_description', '') != '' ) { ?>
							<div class="shop-intro-text">
							<?php echo do_shortcode( wp_kses_post( get_theme_mod('shop_header_description', '') ) ); ?>
							</div>
						<?php } ?>

						<?php if ( ( is_shop() || is_product_category() ) && !is_search() && get_theme_mod('shop_categories_list', true) == true ) {
							goya_subcategories_by_id($cateID);
						} ?>
					</div>
				</header>
			</div>
	...
	<div class="<?php echo esc_attr(implode(' ', $shop_class)); ?>">
		...
		<div id="shop-products" class="shop-products container">
			<div class="row">
				...
				<?php 
					if ( $show_filters_sidebar && !is_search() ) { 
						/**
