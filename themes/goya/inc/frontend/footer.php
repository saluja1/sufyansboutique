...
function goya_footer_elements( $item ) {
	switch ( $item ) {
		case 'copyright':
			echo '<div class="copyright">' . do_shortcode( wp_kses( get_theme_mod( 'footer_bar_copyright', '' ), 'essentials' ) ). '</div>';
			break;

		case 'menu':
			if ( has_nav_menu( 'footer-menu' ) ) {
				echo '<ul id="footer-bar-menu" class="menu">';
				wp_nav_menu( array(
...
add_action( 'goya_after_site', 'goya_back_to_top' );
