...
function goya_blog_pagination() {
	...
	$blog_pagination_style = goya_meta_config('blog','pagination_style','button');
...
function goya_pagination_style () {
	$pagination_style = goya_meta_config('blog','pagination_style','button');
	...
	<div id="authorpage" class="author_info">
		...
		<div class="author-content">
			...
			<?php if(get_the_author_meta('url', $id ) != '') { ?>
				<a href="<?php echo esc_url(get_the_author_meta('url', $id )); ?>" class="auhor-icon" target="_blank"><i class="et-icon et-link"></i></a>
			<?php } ?>
			<?php if(get_the_author_meta('twitter', $id ) != '') { ?>
				<a href="<?php echo esc_url(get_the_author_meta('twitter', $id )); ?>" class="auhor-icon twitter" target="_blank"><i class="et-icon et-twitter"></i></a>
			<?php } ?>
			<?php if(get_the_author_meta('facebook', $id ) != '') { ?>
				<a href="<?php echo esc_url(get_the_author_meta('facebook', $id )); ?>" class="auhor-icon facebook" target="_blank"><i class="et-icon et-facebook"></i></a>
			<?php } ?>
			<?php if(get_the_author_meta('googleplus', $id ) != '') { ?>
				<a href="<?php echo esc_url(get_the_author_meta('googleplus', $id )); ?>" class="auhor-icon google-plus" target="_blank"><i class="et-icon et-google-plus"></i></a>
			<?php } ?>
		</div>
	</div>
<?php
