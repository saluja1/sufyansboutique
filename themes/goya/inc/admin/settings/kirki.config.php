...
if ( class_exists( 'Kirki' ) ) {
	...
	Kirki::add_section( 'header_logo', array(
		'title'          => esc_html__( 'Header Logo', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'header_logo_size', array(
		'title'          => esc_html__('Header/Logo Sizes', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'header_styles', array(
		'title'          => esc_html__('Header Styles', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'header_menu_fullscreen', array(
		'title'          => esc_html__('Full Screen Menu', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'footer_middle', array(
		'title'          => esc_html__( 'Footer Middle', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_footer',
	) );
	...
	Kirki::add_section( 'shop_filters', array(
		'title'          => esc_html__( 'Filters & Variations', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_shop',
	) );
	...
	Kirki::add_section( 'checkout', array(
		'title'          => esc_html__( 'Checkout', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_shop',
	) );
	...
	Kirki::add_section( 'portfolio_home', array(
		'title'          => esc_html__( 'Porfolio Home', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
	...
	Kirki::add_section( 'styling', array(
		'title'          => esc_html__( 'Global Styles', 'goya' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_style',
	) );
	 ...
	 */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description'		=> sprintf( '<span class="attention">%s</span>',
					esc_html__( '* Caution: If may affect your Google Page Speed score if your server is not fast enough', 'goya' )
				), 
				'section'     => 'general_settings',
				'default'     => false,
				'priority'    => 10,
	 ...
	 */
		...
		/* Header Icons */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description' => esc_html__( 'It will be also used for \'add to cart\' buttons', 'goya' ),
				'transport'   => 'postMessage',
				'section'     => 'header_elements',
				'default'     => 'bag',
				'priority'    => 10,
		...
		/* Header Logo */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description'		=> sprintf( '<span class="attention">%s <strong>%s</strong></span>',
					esc_html__( '* Only used if you didn\'t add your logo in', 'goya' ),
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description' => esc_html__( 'Maximum Logo Container Height', 'goya' ),
				'transport' => 'auto',
				'section'     => 'header_logo_size',
				'default'     => 24,
				'priority'    => 10,
				...
				'output'      => array(
					array(
						'element'  => array('.header .logolink .logoimg'),
						'property' => 'max-height',
						'units'    => 'px',
					),
				),
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => array('.header_on_scroll:not(.megamenu-active) .header .logolink .logoimg'),
						'property' => 'max-height',
						'units'    => 'px',
		...
		/* Top Bar */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => array('.top-bar','.top-bar a', '.top-bar .selected'),
						'property' => 'color',
					),
				),
			));
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'       => esc_html__( 'Add button to close', 'goya' ),
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					...
					array(
						'element'  => array('.et-global-campaign .remove:before', '.et-global-campaign .remove:after'),
						'property' => 'background-color',
					),
				),
			));
		...
		/* Header Styles */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => array('.header a','.header .menu-toggle','.header .goya-search button'),
						'property' => 'color',
					),
				),
			));
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					...
					array(
						'element'  => array('.light-title:not(.header_on_scroll) .header .site-title','.light-title:not(.header_on_scroll) .header .et-header-menu>li> a','.sticky-header-light.header_on_scroll .header .et-header-menu>li> a','.light-title:not(.header_on_scroll) span.minicart-counter.et-count-zero','.sticky-header-light.header_on_scroll .header .icon','.sticky-header-light.header_on_scroll .header .menu-toggle','.light-title:not(.header_on_scroll) .header .icon','.light-title:not(.header_on_scroll) .header .menu-toggle'),
						'property' => 'color',
						'media_query' => '@media only screen and (min-width: 768px)',
					),
				),
			...
			Kirki::add_field( 'goya_config', array(
				'type'        => 'slider',
				'settings'    => 'dropdown_menu_column_width',
				'label'       => esc_html__( 'Dropdown Column Width', 'goya' ),
				'transport' => 'auto',
				'section'     => 'header_styles',
				'default'     => 240,
				'priority'    => 10,
				...
				'output'      => array(
					array(
						'element'  => array('.et-header-menu li >.sub-menu > li'),
						'property' => 'width',
						'units'    => 'px',
					),
				),
			...
			Kirki::add_field( 'goya_config', array(
				...
				'transport'   => 'postMessage',
				'section'       => 'header_menu_fullscreen',
				'default'       => 'light',
				'priority'      => 10,
				'choices'	      => array(
					'light'		=> esc_attr__('Light', 'goya'),
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description'	=> esc_html__( 'Items to show on full screen menu', 'goya' ),
				'section'     => 'header_menu_fullscreen',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description'       => esc_html__( 'Additional elementsb below menu', 'goya' ),
				'section'     => 'header_menu_mobile',
				'transport'   => 'postMessage',
	 ...
	 */	
		/* Footer */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'       => esc_html__( 'Enable Footer Middle', 'goya' ),
				'description' => esc_html__( 'Shows content between widgets and bottom bar', 'goya' ),
	 ...
	 */
		...
		/* Shop Header */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'choices'	      => array(
					...
					'shop-hero'		=> esc_attr__('Main and Categories', 'goya'),
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'         => esc_html__( 'Header/Description color mode', 'goya' ),
				'description'   => esc_html__('You can change colors on individual categories on Category edit page', 'goya'),
				'section'       => 'shop_header',
				'default'       => 'dark-title',
				'priority'      => 10,
				'choices'	      => array(
		...
		/* Products Listing */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'       => esc_html__( 'Number of product columns', 'goya' ),
				'description' => esc_html__( 'Here in the customizer go to "WooCommerce > Product Catalog > Products per row" to set the default value', 'goya' ),
				'section'     => 'shop_listing',
				'default'		=> '<input type="text" disabled="disabled" value="4">',
				'priority'    => 10,
				'choices'	  => array (
					'min'	=> 2,
					'max'	=> 6,
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'       => esc_html__( 'Products per Page', 'goya' ),
				'section'     => 'shop_listing',
				'default'     => 12,
				'priority'    => 10,
				'choices'	  => array (
		...
		/* Product Filters */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'section'     => 'shop_filters',
				'priority'    => 10,
				'label'       => esc_html__( 'Filters', 'goya' ),
			));

			Kirki::add_field( 'goya_config', array(
				'type'        => 'toggle',
				'settings'    => 'shop_filters',
				'label'       => esc_html__( 'Shop Filters', 'goya' ),
				'section'     => 'shop_filters',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'       => esc_html__( 'Filters Sidebar Position', 'goya' ),
				'section'     => 'shop_filters',
				'default'     => 'left',
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'goya_config', array(
				...
				'label'       => esc_html__( 'Display color/image swatches in catalog', 'goya' ),
				'description'		=> esc_attr__( 'Requires "WooCommerce Variation Swatches" plugin. Enable if you have a product picture for each color/image variation.', 'goya' ),
				'section'     => 'shop_filters',
				'default'     => false,
				'priority'    => 10,
			));
		...
		/* Shop Styles */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => array('.et-product-detail .single_add_to_cart_button, .sticky-product-bar .single_add_to_cart_button, .sticky-product-bar .add_to_cart_button, .products:not(.shop_display_list) .et-listing-style4 .after_shop_loop_actions .add_to_cart_button.button, .woocommerce-mini-cart__buttons .button.checkout, .button.checkout-button, #place_order.button, .woocommerce .argmc-wrapper .argmc-nav-buttons .argmc-submit, .wishlist_table .add_to_cart.button'),
						'property' => 'background-color',
					),
				),
			));
	 ...
	 */
		...
		/* Product Gallery  */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'description' => esc_html__( 'On mobiles it\'s always carousel', 'goya' ),
				'transport'   => 'postMessage',
	 ...
	 */
		/* Styling */
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => '.yith-wcan-loading:after, .blockUI.blockOverlay:after, .easyzoom-notice:after, .woocommerce-product-gallery__wrapper .slick:after, .add_to_cart_button.loading:after, .et-loader:after',
						'property' => 'background-color',
					),
				),
			));
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => '.button, .button:hover, input[type=submit], input[type=submit]:hover',
						'property' => 'color',
					),
				),
			));
			...
			Kirki::add_field( 'goya_config', array(
				...
				'output'      => array(
					array(
						'element'  => '.button.outlined, .button.outlined:hover, .woocommerce-Reviews .comment-reply-title:hover',
						'property' => 'color',
					),
				),
			));
			...
			/* Second Font: Titles */
				...
				Kirki::add_field( 'goya_config', array(
					...
					'choices'		=> array(
						...
						'widgets'     => esc_attr__('Widget Title (h6)', 'goya'),
