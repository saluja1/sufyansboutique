...
function goya_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'goya-core',
			'source'             => 'https://goyacdn.everthemes.com/assets/plugins/v3-sk036sPu4L/goya-core.zip',
			'required'           => true,
			'version'            => '1.0.2.1',
		...
		array(
			...
			'slug'               => 'js_composer',
			'source'             => 'https://goyacdn.everthemes.com/assets/plugins/v3-sk036sPu4L/js_composer.zip',
			'required'           => false,
			'version'            => '6.4.2',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			...
			'source'             => 'https://goyacdn.everthemes.com/assets/plugins/v3-sk036sPu4L/wc-ajax-product-filter.zip',
			'required'           => false,
			'version'            => '2.0.3.2',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => 'https://goyacdn.everthemes.com/assets/plugins/v3-sk036sPu4L/revslider.zip',
			'required'           => false,
			'version'            => '6.3.3',
			'force_activation'   => false,
			'force_deactivation' => false,
