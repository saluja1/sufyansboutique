...
<article itemscope itemtype="http://schema.org/Article" <?php post_class($class); ?>>
					...
					if ( $categories_list || $tag_list) { ?>
						...
						<div class="single-post-meta">
							<?php if ( $categories_list ) {
								echo '<span class="posted_in">' . esc_html__( 'Posted in: ', 'goya' ) . $categories_list . '</span>';
							}

							if ( $tag_list ) {
								echo '<span class="tagged_as">' . esc_html__( 'Tagged: ', 'goya' ) . $tag_list . '</span>';
							} ?>
						</div>
