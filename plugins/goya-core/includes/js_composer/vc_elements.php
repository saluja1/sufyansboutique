...
vc_add_param('vc_row', array(
	'type' => 'checkbox',
	'heading' => esc_html__('Enable Full Width', 'goya'),
	'param_name' => 'et_full_width',
	'value' => array(
		'Yes' => 'true'
	),
	'weight' => 1,
	'description' => esc_html__('If you enable this, this row will fill the screen', 'goya')
));
vc_add_param('vc_row', array(
	'type' => 'checkbox',
	'heading' => esc_html__('Disable Padding', 'goya'),
	'param_name' => 'et_row_padding',
	'value' => array(
		'Yes' => 'true'
	),
	'weight' => 1,
	'description' => esc_html__('If you enable this, this row won\'t leave padding on the sides', 'goya')
));
vc_add_param('vc_row', array(
	'type' => 'dropdown',
	'heading' => esc_html__('Column Alignment', 'goya'),
	...
	'weight' => 1,
	'description' => esc_html__('Aligment for the columns inside this row.', 'goya')
));
...
vc_add_param('vc_row_inner', array(
	'type' => 'checkbox',
	'heading' => esc_html__('Enable Max Width', 'goya'),
	...
	'std' => 'max_width',
	'weight' => 1,
	'description' => esc_html__('If you enable this, the row won\'t exceed the max width, especially inside a full-width parent row.', 'goya')
));
...
vc_add_param('vc_row_inner', array(
	...
	'weight' => 1,
	'description' => esc_html__('If you enable this, the columns inside won\'t leave padding on the sides', 'goya')
));
...
vc_add_param('vc_column', array(
	'type' => 'dropdown',
	'heading' => esc_html__('Column Content Color', 'goya'),
	...
	'std' => 'et-dark-column',
	'weight' => 1,
	'description' => esc_html__('If you white-colored contents for this column, select Light.', 'goya')
));
vc_add_param('vc_column', array(
	'type' => 'dropdown',
	'heading' => esc_html__('Overlap column', 'goya'),
	...
	'weight' => 1,
	'description' => esc_html__('Overlap adjacent columns.', 'goya')
));
vc_add_param('vc_column', array(
	'type' => 'checkbox',
	'heading' => esc_html__('Enable Fixed Content', 'goya'),
	'param_name' => 'fixed',
	'value' => array(
		'Yes' => 'et-fixed'
	),
	'weight' => 1,
	'description' => esc_html__('If you enable this, this column will be fixed.', 'goya')
));
...
vc_add_param('vc_toggle', array(
	'type' => 'dropdown',
	'heading' => esc_html__('Toggle style', 'goya'),
	'param_name' => 'style',
	'value' => array(
		'Default' => 'default',
		'Simple' => 'simple'
