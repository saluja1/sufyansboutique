...
class Goya_Widget_Latest_Images extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			...
			'description' => __('Display latest posts with images', 'goya' )
		);
		
		parent::__construct(
			'et_latestimages_widget',
			__( 'Goya - Latest Posts with Images' , 'goya' ),
			$widget_ops
		);
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e('Widget Title:', 'goya' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'name' )); ?>"><?php esc_html_e('Number of Posts:', 'goya' ); ?></label>
