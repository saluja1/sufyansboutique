...
function goya_portfolio_register_meta_boxes( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			array(
				'name' => esc_html__('Hover Color', 'goya' ),
				'desc' => esc_html__('Set color for hover effect. Used on the Hover Card style.', 'goya' ),
				'id'   => $prefix . 'hover_color',
				'type' => 'color',
			),
			array(
				'name' => esc_html__('Masonry item size', 'goya' ),
				'desc' => esc_html__('Size of the item on the masonry portfolio mode.', 'goya' ),
	...
	$meta_boxes[] = array(
		'id' => 'et-post-gallery',
		'title' => esc_html__('Portfolio Details', 'goya' ),
		'pages' => array( 'portfolio' ),
		'context' => 'normal',
		'priority' => 'high',
		'fields' => array(
			array(
				'name'  => esc_html__('Featured Image', 'goya' ),
				'desc' => esc_html__('Add image to show on header. Used on the Parallax mode.', 'goya' ),
				'id' => $prefix . 'featured_gallery',
				'type' => 'image_advanced',
				'max_file_uploads' => 5,
			),
			array(
				'name'  => esc_html__('Date', 'goya' ),
				'id' => $prefix . 'date',
				'type' => 'date',
				'timestamp' => true,
			),
			array(
				'name'  => esc_html__('Author', 'goya' ),
				'id' => $prefix . 'author',
				'type' => 'text',
			),
			array(
				'name'  => esc_html__('Website', 'goya' ),
				'id' => $prefix . 'website',
				'type' => 'fieldset_text',
				'options' => array(
	        'text'    => 'Text',
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name' => esc_html__('Header Style', 'goya' ),
			...
			array(
				'name' => esc_html__('Header Text Color', 'goya' ),
			...
			array(
		    'type' => 'heading',
		    'name' => esc_html__('Title Options', 'goya'),
			),
			array(
				'name' => esc_html__('Title Layout', 'goya' ),
				'desc' => esc_html__('Override single portfolio layout.', 'goya' ),
			...
			array(
				'name' => esc_html__('Title Text Color', 'goya' ),
			...
			array(
				'name' => esc_html__('Title Background', 'goya' ),
			...
			array(
		    'type' => 'heading',
		    'name' => esc_html__('Other options', 'goya'),
			),
			array(
				'name' => esc_html__('Page Background Color', 'goya' ),
				'desc' => esc_html__('Set background for the whole page.', 'goya' ),
