...
function goya_page_register_meta_boxes( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name' => esc_html__('Page Title', 'goya' ),
				'id'   => $prefix . 'title_style',
				'class' => 'page-header-title',
				'type' => 'select',
				'options'  => array(
					'regular' => esc_html__('Regular Title', 'goya'),
					'hero'    => esc_html__('Hero Title', 'goya'),
					'hide'    => esc_html__('Hide Page Title', 'goya'),
				),
			),
			array(
			...
			array(
				'name' => esc_html__('Show Featured Image', 'goya' ),
				'desc' => esc_html__('Set featured image as title background.', 'goya' ),
				'class' => 'page-header-field page-hero-title hidden',
			...
			array(
				'name' => esc_html__('Page Sidebar Position/Status', 'goya' ),
				'id'   => $prefix . 'sidebar_position',
				'type' => 'select',
				'options'  => array(
					'left'  => esc_html__('Left', 'goya'),
					'right' => esc_html__('Right', 'goya'),
					'disable'  => esc_html__('Disable on this page', 'goya'),
				),
			),
			array(
			...
			array(
				'name' => esc_html__('Disable Footer', 'goya' ),
